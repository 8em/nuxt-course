<template>
  <div class="flex">
    ...
    <button
      @click="toggleMode"
      @mouseenter="showNextIconLabel = true"
      @mouseleave="showNextIconLabel = false"
      class="text-2xl hover:bg-gray-200 text-4xl md:text-base dark:hover:bg-gray-400 rounded-md px-1 py-1"
    >
      {{ nextModeIcon }}
    </button>
  </div>
